...
TODO
* finalize interpretations of regression results
* add note that the data is very dirty, and the analysis is far from comprehensive
...
``` {r regression_run, warning=FALSE}
...
``` {r coef_plot_energy, warning=FALSE, fig.width=10, fig.height=6}
